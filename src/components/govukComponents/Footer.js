...
function Footer(props) {
      ...
      <>
        <div className="govuk-footer__navigation">
          {props.navigation.map((nav, navIndex) => (
            <div className="govuk-footer__section" key={navIndex}>
        ...
        <>
          ...
          <ul className="govuk-footer__inline-list">
            {props.meta.items.map((item, index) => (
              <li className="govuk-footer__inline-list-item" key={index}>
                <Link classes={`govuk-footer__link ${item.classes || ''}`} to={item.to} href={item.href} {...item.attributes}>
                  {item.text}
                </Link>
              </li>
  ...
  return (
    <footer className={`govuk-footer ${props.classes}`} role="contentinfo" {...props.attributes}>
