...
function Header(props) {
    ...
    if (props.serviceName || props.navigation) {
        navigation = <div className="govuk-header__content">
            {props.serviceName ? <a href={props.serviceUrl} className="govuk-header__link govuk-header__link--service-name">
                {props.serviceName}
            </a> : null}
                ...
                <nav>
                    <ul id="navigation" className={`govuk-header__navigation ${props.navigationClasses ? props.navigationClasses : ''}`} aria-label="Top Level Navigation">
                        {props.navigation.map((link, index) =>
                            <li className="govuk-header__navigation-item" key={'navigation' + index}>
    ...
    return (
        <header className={`govuk-header${props.classes ? " " + props.classes : ''}`} role="banner" data-module="header" {...attributes}>
                    ...
                    <a href={props.homepageUrl} className="govuk-header__link govuk-header__link--homepage">
                        <span className="govuk-header__logotype">
                            ...
                            >
                                ...
                                ></path>
                                <image src={`${props.assestsPath}/govuk-logotype-crown.png`} className="govuk-header__logotype-crown-fallback-image"></image>
                            </svg>
