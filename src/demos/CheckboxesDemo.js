...
function CheckboxesDemo() {
  ...
  const emailHtml = <Input id="contacty-by-email" name="contact-by-email" type="email" classes="govuk-!-width-one-third" label={{ text: "Email address" }} attributes={{ spellCheck: "false" }} />
  const phoneHtml = <Input id="contacty-by-email" name="contact-by-email" type="email" classes="govuk-!-width-one-third" label={{ text: "Email address" }} attributes={{ spellCheck: "false" }} />
  const textHtml = <Input id="contacty-by-email" name="contact-by-email" type="email" classes="govuk-!-width-one-third" label={{ text: "Email address" }} attributes={{ spellCheck: "false" }} />
