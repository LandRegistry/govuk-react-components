  ...
  const demoData = {
    "rows": [
       ...
       },
       {
          ...
          "value": {
             "html": <><p className="govuk-body">email@email.com</p><p className="govuk-body">Address line 1<br />Address line 2<br />Address line 3<br />Address line 4<br />Address line 5</p></>
          },
          "actions": {
             "items": [
                {
